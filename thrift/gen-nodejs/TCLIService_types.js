...
TPrimitiveTypeEntry = module.exports.TPrimitiveTypeEntry = function(args) {
  ...
  if (args) {
    ...
    if (args.typeQualifiers !== undefined) {
      this.typeQualifiers = args.typeQualifiers;
    }
  }
};
...
TColumn = module.exports.TColumn = function(args) {
  ...
  if (args) {
    ...
    if (args.binaryVal !== undefined) {
      this.binaryVal = args.binaryVal;
    }
  }
};
TColumn.prototype = {};
...
TGetDelegationTokenResp = module.exports.TGetDelegationTokenResp = function(args) {
  ...
  if (args) {
    ...
    if (args.delegationToken !== undefined) {
